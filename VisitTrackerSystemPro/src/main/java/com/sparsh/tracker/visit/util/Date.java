...
public class Date implements Cloneable {
     ...
     * @param date java.util.Date
     */
    public Date(final java.sql.Timestamp timestamp) {
        super();
        this.date = new GregorianCalendar();
     ...
     */
    public void addDay(final int numberOfDays) {
     ...
     * @param number
     */
    public void add(final int number, final int type) {
     ...
     */
    public void addMinutes(final int numberOfMinutes) {
     ...
     */
    public void addMonth(final int numberOfMonths) {
     ...
     * @param numberOfDays int
     */
    public Date addSecond(final int numberOfSeconds) {
     ...
     */
    public boolean after(final Date param) {
     ...
     * @param param com.kariba.infrastructure.Date
     */
    public int compareTo(final Date param) {
     ...
     */
    public int dayDiff(final Date endDate) {
        Date fromDate;
        Date toDate;
        boolean negative;
     ...
     * @param param com.kariba.infrastructure.Date
     */
    public boolean equals(final Date param) {
        if (param == null) {
            return false;
        }
     ...
     * @param param com.kariba.infrastructure.Date
     */
    public boolean equalsIgnoreTime(final Date param) {
        if (param == null) {
            return false;
        }
     ...
     * @param day
     */
    public void setYearMonthDay(final int year, final int month, final int day) {

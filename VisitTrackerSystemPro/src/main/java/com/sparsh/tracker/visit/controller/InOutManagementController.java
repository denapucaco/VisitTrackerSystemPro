...
public class InOutManagementController {
	...
	public String listVisitors(Map<String, Object> model, HttpSession session) {
...
//			model.put("userName", login.getUserName());
	...
	public String selectVisit(@RequestParam(value="visitId") String visitId, Map<String, Object> model, HttpSession session) {
		try {
...
//				model.put("userName", login.getUserName());
	...
	@Transactional
	public String invisit(@ModelAttribute("SpringWeb")Visit visit, Map<String, Object> model, HttpSession session) {
		try {
...
//			model.put("userName", login.getUserName());
	...
	@Transactional
	public String outvisit(@ModelAttribute("SpringWeb")Visit visit, Map<String, Object> model, HttpSession session) {
		try {
